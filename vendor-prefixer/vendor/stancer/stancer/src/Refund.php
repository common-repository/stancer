...
class Refund extends Stancer\Core\AbstractObject
{
     ...
     */
    protected $dataModel = ['amount' => ['desc' => 'Amount to refund', 'exportable' => \true, 'nullable' => \false, 'restricted' => \true, 'size' => ['min' => 50], 'type' => self::INTEGER], 'currency' => ['desc' => 'Processed currency', 'exportable' => \true, 'nullable' => \false, 'restricted' => \true, 'type' => self::STRING], 'dateBank' => ['desc' => 'Delivery date of the funds by the bank', 'restricted' => \true, 'type' => DateTimeImmutable::class], 'dateRefund' => ['desc' => 'Date when the API sent the refund request to the bank', 'restricted' => \true, 'type' => DateTimeImmutable::class], 'payment' => ['desc' => 'Refunded payment identifier', 'exportable' => \true, 'nullable' => \false, 'restricted' => \true, 'type' => Stancer\Payment::class], 'status' => ['desc' => 'Refund status', 'restricted' => \true, 'type' => self::STRING]];
    /**
    ...
    public function send() : Stancer\Core\AbstractObject
    {
        ...
        // Mandatory, force `parent::send()` to work even if no amount is set.
        $this->modified[] = 'payment';
        // Mandatory, force `parent::send()` to work even if no amount is set.
        parent::send();
