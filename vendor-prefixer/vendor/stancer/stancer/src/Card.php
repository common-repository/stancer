...
class Card extends Stancer\Core\AbstractObject implements Stancer\Interfaces\PaymentMeansInterface
{
     ...
     */
    protected $dataModel = ['brand' => ['desc' => 'Card brand', 'restricted' => \true, 'type' => self::STRING], 'country' => ['desc' => 'Card country', 'restricted' => \true, 'type' => self::STRING], 'cvc' => ['desc' => 'Card Validation Code', 'exception' => Stancer\Exceptions\InvalidCardCvcException::class, 'required' => \true, 'size' => ['fixed' => 3], 'type' => self::STRING], 'expMonth' => ['desc' => 'Card expiration month', 'required' => \true, 'type' => self::INTEGER], 'expYear' => ['desc' => 'Card expiration year', 'required' => \true, 'type' => self::INTEGER], 'funding' => ['desc' => 'Card funding', 'restricted' => \true, 'type' => self::STRING], 'last4' => ['desc' => 'Card last 4 digits', 'restricted' => \true, 'type' => self::STRING], 'name' => ['desc' => 'Card holder\'s name', 'size' => ['min' => 3, 'max' => 64], 'type' => self::STRING], 'nature' => ['desc' => 'Card nature', 'restricted' => \true, 'type' => self::STRING], 'network' => ['desc' => 'Card network', 'restricted' => \true, 'type' => self::STRING], 'number' => ['desc' => 'Card number', 'required' => \true, 'size' => ['min' => 16, 'max' => 19], 'type' => self::STRING], 'tokenize' => ['type' => self::BOOLEAN], 'zipCode' => ['size' => ['min' => 2, 'max' => 8], 'type' => self::STRING]];
    /**
    ...
    {
        $names = ['amex' => 'American Express', 'dankort' => 'Dankort', 'discover' => 'Discover', 'jcb' => 'JCB', 'maestro' => 'Maestro', 'mastercard' => 'MasterCard', 'visa' => 'VISA'];
        $brand = $this->getBrand();
