...
namespace Stancer\Scoped\Isolated\Stancer\Core\Request;
...
class Call extends Stancer\Core\AbstractObject
{
     ...
     */
    protected $dataModel = ['exception' => ['desc' => 'The exception catched during processing', 'restricted' => \true, 'type' => Stancer\Exceptions\Exception::class], 'request' => ['desc' => 'Called request', 'restricted' => \true, 'type' => Psr\Http\Message\RequestInterface::class], 'response' => ['desc' => 'The response received', 'restricted' => \true, 'type' => Psr\Http\Message\ResponseInterface::class]];
}
