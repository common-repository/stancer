...
use Stancer\Scoped\Isolated\Override;
...
class Payout extends Stancer\Core\AbstractObject
{
     ...
     */
    protected $dataModel = ['amount' => ['desc' => 'The total credit transfer amount you will receive', 'nullable' => \false, 'restricted' => \true, 'type' => self::INTEGER], 'currency' => ['desc' => 'Processed currency', 'nullable' => \false, 'restricted' => \true, 'type' => self::STRING], 'dateBank' => ['desc' => 'The date you will receive the credit transfer', 'format' => Stancer\Core\Type\Helper::DATE_ONLY, 'restricted' => \true, 'type' => DateTimeImmutable::class], 'datePaym' => ['desc' => 'The date the payment transactions were made', 'format' => Stancer\Core\Type\Helper::DATE_ONLY, 'nullable' => \false, 'restricted' => \true, 'type' => DateTimeImmutable::class], 'datePayment' => ['desc' => 'The date the payment transactions were made', 'nullable' => \false, 'restricted' => \true, 'type' => DateTimeImmutable::class], 'details' => ['desc' => 'Payout details', 'nullable' => \false, 'restricted' => \true, 'type' => Stancer\Payout\Details::class], 'fees' => ['desc' => 'The fees you paid for processing the payments', 'nullable' => \false, 'restricted' => \true, 'type' => self::INTEGER], 'status' => ['desc' => 'Payout status', 'nullable' => \false, 'restricted' => \true, 'type' => self::STRING], 'statementDescription' => ['desc' => 'The statement description, will be used on the transfer', 'restricted' => \true, 'type' => self::STRING]];
    /**
    ...
    {
        $data['details'] = [];
        $items = ['disputes', 'payments', 'refunds'];
