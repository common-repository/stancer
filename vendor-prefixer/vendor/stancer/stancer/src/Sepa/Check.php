...
namespace Stancer\Scoped\Isolated\Stancer\Sepa;
...
class Check extends Stancer\Core\AbstractObject
{
     ...
     */
    protected $dataModel = ['dateBirth' => ['restricted' => \true, 'type' => self::BOOLEAN], 'response' => ['restricted' => \true, 'size' => ['min' => 2, 'max' => 4], 'type' => self::STRING], 'scoreName' => ['coerce' => Stancer\Core\Type\Helper::INTEGER_TO_PERCENTAGE, 'restricted' => \true, 'type' => self::FLOAT], 'sepa' => ['restricted' => \true, 'type' => Stancer\Sepa::class], 'status' => ['restricted' => \true, 'type' => self::STRING]];
    /**
    ...
    {
        $this->modified[] = 'sepa';
        // Mandatory, force `parent::send()` to work.
        return parent::send();
    }
}
