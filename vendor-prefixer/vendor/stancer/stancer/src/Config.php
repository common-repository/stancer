...
class Config
{
    ...
    protected $keys = ['pprod' => null, 'ptest' => null, 'sprod' => null, 'stest' => null];
    ...
    public function getUri() : string
    {
        ...
        $params = ['https', $this->getHost(), $this->getPort(), $this->getVersion()];
    ...
    ) : self
    {
        ...
        $prefixes = ['pprod', 'ptest', 'sprod', 'stest'];
        foreach ($keys as $key) {
    ...
    {
        $validMode = [static::LIVE_MODE, static::TEST_MODE];
        if (!\in_array($mode, $validMode, \true)) {
