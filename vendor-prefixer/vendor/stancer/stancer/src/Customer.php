...
class Customer extends Stancer\Core\AbstractObject
{
     ...
     */
    protected $dataModel = ['email' => ['desc' => 'Customer\'s email', 'size' => ['min' => 5, 'max' => 64], 'type' => self::STRING], 'externalId' => ['desc' => 'External identifier', 'size' => ['max' => 36], 'type' => self::STRING], 'mobile' => ['desc' => 'Customer\'s mobile phone', 'size' => ['min' => 8, 'max' => 16], 'type' => self::STRING], 'name' => ['desc' => 'Customer\'s name', 'size' => ['min' => 3, 'max' => 64], 'type' => self::STRING]];
    /**
     * Send a customer.
     *
     * @uses Request::post()
