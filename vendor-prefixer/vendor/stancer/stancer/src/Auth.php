...
class Auth extends Stancer\Core\AbstractObject
{
     ...
     */
    protected $dataModel = ['redirectUrl' => ['desc' => 'The redirection URL to start an authentification session', 'restricted' => \true, 'type' => self::STRING], 'returnUrl' => ['desc' => 'The return URL at end of the authentification session', 'size' => ['min' => 1, 'max' => 2048], 'type' => self::STRING], 'status' => ['desc' => 'The authentification status', 'exportable' => \true, 'restricted' => \true, 'type' => self::STRING, 'value' => Stancer\Auth\Status::REQUEST]];
    /** @var string[] */
    protected $modified = ['status'];
    /**
     * Update return URL.
     *
