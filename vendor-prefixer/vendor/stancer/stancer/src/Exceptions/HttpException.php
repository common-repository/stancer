...
use Stancer\Scoped\Isolated\GuzzleHttp\Exception\RequestException;
...
class HttpException extends Exception implements Stancer\Interfaces\ExceptionInterface
{
    ...
    {
        $list = [310 => TooManyRedirectsException::class, 400 => BadRequestException::class, 401 => NotAuthorizedException::class, 402 => PaymentRequiredException::class, 403 => ForbiddenException::class, 404 => NotFoundException::class, 405 => MethodNotAllowedException::class, 406 => NotAcceptableException::class, 407 => ProxyAuthenticationRequiredException::class, 408 => RequestTimeoutException::class, 409 => ConflictException::class, 410 => GoneException::class, 500 => InternalServerErrorException::class];
        if (\array_key_exists($status, $list)) {
            return $list[$status];
        }
        $levels = [3 => RedirectionException::class, 4 => ClientException::class, 5 => ServerException::class];
