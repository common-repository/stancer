...
class Details extends Stancer\Core\AbstractObject
{
     ...
     */
    protected $dataModel = ['disputes' => ['desc' => 'Disputes details', 'restricted' => \true, 'type' => Stancer\Payout\Details\Inner::class], 'payments' => ['desc' => 'Payments details', 'restricted' => \true, 'type' => Stancer\Payout\Details\Inner::class], 'refunds' => ['desc' => 'Refunds details', 'restricted' => \true, 'type' => Stancer\Payout\Details\Inner::class]];
    /**
