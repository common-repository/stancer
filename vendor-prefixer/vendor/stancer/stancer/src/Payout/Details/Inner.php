...
namespace Stancer\Scoped\Isolated\Stancer\Payout\Details;
...
class Inner extends Stancer\Core\AbstractObject
{
     ...
     */
    protected $dataModel = ['amount' => ['nullable' => \false, 'restricted' => \true, 'type' => self::INTEGER], 'currency' => ['nullable' => \false, 'restricted' => \true, 'type' => self::STRING], 'parent' => ['nullable' => \false, 'exportable' => \false, 'restricted' => \true, 'type' => Stancer\Payout::class], 'type' => ['nullable' => \false, 'exportable' => \false, 'restricted' => \true, 'type' => self::STRING]];
    /**
     * List elements.
     *
    ...
    {
        $map = ['disputes' => Stancer\Dispute::class, 'payments' => Stancer\Payment::class, 'refunds' => Stancer\Refund::class];
