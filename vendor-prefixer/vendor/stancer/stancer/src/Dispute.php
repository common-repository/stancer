...
class Dispute extends Stancer\Core\AbstractObject
{
     ...
     */
    protected $dataModel = ['amount' => ['desc' => 'The disputed amount', 'nullable' => \false, 'restricted' => \true, 'type' => self::INTEGER], 'currency' => ['desc' => 'The currency of the disputed amount', 'coerce' => Stancer\Core\Type\Helper::TO_LOWER, 'nullable' => \false, 'restricted' => \true, 'type' => self::STRING], 'orderId' => ['desc' => 'The order_id you specified in your inital payment request', 'restricted' => \true, 'size' => ['min' => 1, 'max' => 36], 'type' => self::STRING], 'payment' => ['desc' => 'The related payment\'s identifier', 'nullable' => \false, 'restricted' => \true, 'type' => Stancer\Payment::class], 'response' => ['desc' => 'The response code', 'nullable' => \false, 'restricted' => \true, 'type' => self::STRING]];
}
