...
class Sepa extends Stancer\Core\AbstractObject implements Stancer\Interfaces\PaymentMeansInterface
{
     ...
     */
    protected $dataModel = ['bic' => ['desc' => 'Bank Identifier Code', 'required' => \false, 'type' => self::STRING], 'check' => ['restricted' => \true, 'type' => Stancer\Sepa\Check::class], 'country' => ['desc' => 'IBAN country', 'restricted' => \true, 'type' => self::STRING], 'dateBirth' => ['desc' => 'Account holder birth date', 'format' => Stancer\Core\Type\Helper::DATE_ONLY, 'type' => DateTimeInterface::class], 'dateMandate' => ['desc' => 'Mandate signature date', 'type' => DateTimeInterface::class], 'iban' => ['desc' => 'International Bank Account Number', 'required' => \true, 'type' => self::STRING], 'last4' => ['desc' => 'IBAN last 4 characters', 'restricted' => \true, 'type' => self::STRING], 'mandate' => ['desc' => 'Mandate number', 'size' => ['min' => 3, 'max' => 35], 'type' => self::STRING], 'name' => ['desc' => 'Account holder name', 'required' => \true, 'size' => ['min' => 3, 'max' => 64], 'type' => self::STRING]];
    /**
