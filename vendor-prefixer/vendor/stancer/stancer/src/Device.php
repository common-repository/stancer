...
class Device extends Stancer\Core\AbstractObject
{
     ...
     */
    protected $dataModel = ['city' => ['desc' => 'City of the payer', 'restricted' => \true, 'type' => self::STRING], 'country' => ['desc' => 'Country of the payer', 'restricted' => \true, 'type' => self::STRING], 'httpAccept' => ['desc' => 'HTTP Accept header', 'type' => self::STRING], 'ip' => ['desc' => 'IP address of the payer', 'type' => self::STRING], 'languages' => ['desc' => 'HTTP Accept-Language header', 'type' => self::STRING], 'port' => ['desc' => 'TCP port number of the payer', 'size' => ['min' => 1, 'max' => 65535], 'type' => self::INTEGER], 'userAgent' => ['desc' => 'HTTP User Agent header', 'type' => self::STRING]];
    /**
