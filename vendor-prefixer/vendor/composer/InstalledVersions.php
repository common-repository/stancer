 ...
 */
namespace Stancer\Scoped\Isolated\Composer;

use Stancer\Scoped\Isolated\Composer\Autoload\ClassLoader;
use Stancer\Scoped\Isolated\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('Stancer\\Scoped\\Isolated\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
